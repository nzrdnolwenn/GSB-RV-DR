...
CREATE TABLE `Motif` (
  ...
  `mot_libelle` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`mot_num`)
...
CREATE TABLE `RapportVisite` (
  ...
  KEY `FK_RAPPORT-VISITE_MOTIF` (`mot_num`),
...
('a131',1,'2022-12-05','Doit rester au lit pendant 1 semaine, médicament matin,midi et soir.',1,1,NULL,3,NULL),
('b16',2,'2022-11-10','Doit bien se couvrir et boire du lait au miel chaud chaque soir pendant 1 semaine',64,2,NULL,2,NULL),
('b19',5,'2022-10-10','Prise de sang à effectuer sous 5 jours',50,3,NULL,1,NULL),
('b50',3,'2022-11-28','Confinement d 1 semaine sans aucun contact avec quiconque',10,3,NULL,5,NULL),
('e49',6,'2022-12-02','Repos, serum physiologique tout les soirs avant de dormir',32,5,NULL,2,NULL),
('f4',7,'2022-11-11','Aucune prescription spéciale',60,2,NULL,0,NULL),
('s21',4,'2022-12-01','Aucune prescription spéciale',73,4,NULL,3,NULL);
...
/*!40000 ALTER TABLE `connaitre` DISABLE KEYS */;
/*!40000 ALTER TABLE `connaitre` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-02-17 13:42:35
